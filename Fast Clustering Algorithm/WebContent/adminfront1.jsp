									...
									<table height="120">
										<tr>
											...
											<td>
												...
												<tr>
													<td class="s1" align="right">File
														Name&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;</td>
													<td class="s1"><input type="text" name="username"
														value="<%=filename%>"></td>
												</tr>
												...
												<tr>
													<td class="s1" align="right">File
														KEY&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;</td>
													<td class="s1"><input type="filekey" name="filekey"
														value="<%=filekey%>"></td>
												</tr>
												...
												<tr>
													<td class="s1" align="right">File
														SUBKEY&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;</td>
													<td class="s1"><input type="filesubkey"
														name="filesubkey" value="<%=filesubkey%>"></td>
												</tr>
												...
												<form name="f2" action="fileinsert1.jsp"
													...
													<tr>
														...
														<td><input type="submit" name="s" value="submit"
															class="b1"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input
																type="reset" name="r" value="clear" class="b1"></td>
													</tr>
												</form>
									</table>
								</td>
